...
7. Admin Logout Page
    [Documentation]  This test is for Admin to Logout
    [Tags]  admin
    Open Browser    ${web_url}   chrome
    sleep  2s
    Test 1 admname
...
Test 2 Address
    Input Text  name:address  Mysore

Test 2 Dob
    Input Text  name:dob   01-06-1981

Test 2 Place
    Input Text  name:place  Karnataka

Test 2 Pincode
    Input Text  name:pincode    590068

Test 5 Name
    Input Text  name:name  Mary Gayathri
